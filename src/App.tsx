...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#070b13] text-[#e9edf3] flex flex-col font-sans selection:bg-[#1a2c47] selection:text-[#7cb5ff]">
      ...
      {/* Top Navbar Header */}
      <header className="border-b border-[#242e3f] bg-[#0f1521]/80 backdrop-blur sticky top-0 z-10 px-4 sm:px-8 py-3.5 flex items-center justify-between">
      ...
      {/* Main Container anchored to top for consistent alignment */}
      <main className="flex-1 flex flex-col justify-start items-center p-4 sm:p-8 pt-6 sm:pt-10">
        <div className="w-full max-w-[680px] bg-[#0f1521] border border-[#242e3f] rounded-2xl overflow-hidden shadow-2xl flex flex-col">
                ...
                <div className="p-6 text-center space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-[#3b82f6] hover:bg-[#2f74e8] text-white font-semibold py-2.5 rounded-xl text-[13px] transition-all duration-150"
                    >
                      View All Tickets
                    </button>
                  </div>
          ...
          {activeTab === 'list' && (
            <div className="p-5 sm:p-7 space-y-5 flex flex-col justify-start transition-opacity duration-150 ease-in-out">
              ...
              {/* Pagination Controls neatly attached under ticket list */}
              {totalPages > 1 && (
